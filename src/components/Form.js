                ...
                <div class="row text-left mt-3">
                    <div class="col-md-6 mr-1"> 
                        <div class="form-group">
                                ...
                                <input class="form-control text-info font-weight-bold" name="notes" onChange={props.handleChange} defaultValue={props.projectInfo?.notes}/> 
                        </div>
                    </div>
                    <div class="col-md-5"> 
                        <div class="form-group">
                                ...
                                <input placeholder='dd-mm-yyyy' class="form-control text-info font-weight-bold" name="endDate" onChange={props.handleChange} defaultValue={props.projectInfo?.endDate}/> 
                        </div>
                    </div>
                </div>
