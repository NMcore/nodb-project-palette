  ...
  <div class="sidebar template-col-default mr-2" ata-color="white" style={{backgroundColor: props.templateColor[2]}} data-active-color="danger">
    ...
    <div class="sidebar-wrapper">
      <ul class="nav">
        ...
        <li>
          <a href="./icons.html">
            <i style={{color: props.templateTextColor[0]}} class="nc-icon nc-diamond"></i>
        ...
        <li>
          <a href="./notifications.html">
            <i style={{color: props.templateTextColor[0]}} class="nc-icon nc-bell-55"></i>
            <p style={{color: props.templateTextColor[0]}}>Notifications</p>
          </a>
        </li>
        <li>
          <a href="./user.html">
            <i style={{color: props.templateTextColor[0]}} class="nc-icon nc-single-02"></i>
        ...
        <li class="active-pro">
          <a href="./upgrade.html">
            ...
            <p style={{color: props.templateTextColor[0]}}>Upgrade to PRO</p>
          </a>
        </li>
      </ul>
    </div>
  </div>
  <div class="main-panel" style={{ backgroundColor: props.templateColor[0] }}>
    <nav style={{backgroundColor: props.templateColor[1]}} class="navbar navbar-expand-lg navbar-absolute fixed-top navbar-transparent-template">
          ...
          <ul class="navbar-nav">
            <li class="nav-item">
              <a class="nav-link btn-magnify" href="javascript:;">
                <i style={{color: props.templateTextColor[0]}} class="nc-icon nc-layout-11"></i>
                <p>
            ...
            <li class="nav-item btn-rotate dropdown">
              <a style={{color: props.templateTextColor[0]}} class="nav-link dropdown-toggle" href="http://example.com" id="navbarDropdownMenuLink"
            ...
            <li class="nav-item">
              <a class="nav-link btn-rotate" href="javascript:;">
                <i style={{color: props.templateTextColor[0]}} class="nc-icon nc-settings-gear-65"></i>
                <p>
